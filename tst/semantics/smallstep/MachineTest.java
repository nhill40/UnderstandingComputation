...
public class MachineTest implements SemanticsTest {
    ...
    public void test_addTwoVarsAndAssign() {
        ...
        environment.put("x", new Number(3));
        environment.put("y", new Number(4));

        Machine machine = new Machine(assign, environment);
        machine.run();
        assertEquals("do-nothing, {y=4, x=7}", machine.toString());
    }
    ...
    public void test_addVarToNumberAndAssign() {
        ...
        Machine machine = new Machine(assign, environment);
        machine.run();
        assertEquals("do-nothing, {x=3}", machine.toString());
    }
    ...
    public void test_if() {
        ...
        Machine machine = new Machine(ifStatement, environment);
        machine.run();
        assertEquals("do-nothing, {y=1, x=true}", machine.toString());
    }
    ...
    public void test_sequence() {
        ...
        Machine machine = new Machine(sequence, new HashMap<String, Expression>());
        machine.run();
        assertEquals("do-nothing, {y=5, x=2}", machine.toString());
    }
    ...
    public void test_while() {
        ...
        Machine machine = new Machine(whileStatement, environment);
        machine.run();
        assertEquals("do-nothing, {x=9}", machine.toString());
    }
}
