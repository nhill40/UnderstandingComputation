...
public class FATestStates {
    ...
    public static final SingleState STATE4 = new SingleState(4);
    public static final SingleState STATE5 = new SingleState(5);
    public static final SingleState STATE6 = new SingleState(6);
}
